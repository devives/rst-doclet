 ...
 */
public class RstConfiguration extends BaseConfiguration {
     ...
     */
    public final Set<HtmlConfiguration.ConditionalPage> conditionalPages;
     ...
     */
    public RstConfiguration(Doclet doclet, Locale locale, Reporter reporter) {
        ...
        conditionalPages = EnumSet.noneOf(HtmlConfiguration.ConditionalPage.class);
    }

    private static class LocalHtmlConfiguration extends HtmlConfiguration {

        public LocalHtmlConfiguration(Doclet doclet, Locale locale, Reporter reporter) {
            super(doclet, locale, reporter);
        }
    ...
    protected void initConfiguration(DocletEnvironment docEnv,
        ...
        super.initConfiguration(docEnv, resourceKeyMapper);
        LocalHtmlConfiguration htmlConfiguration = new LocalHtmlConfiguration(doclet, locale, reporter);
        htmlConfiguration.initConfiguration(docEnv, resourceKeyMapper);
        contents = htmlConfiguration.contents;
        htmlIds = htmlConfiguration.htmlIds;
    }
...
//        }
    ...
    public WriterFactory getWriterFactory() {
        throw new UnsupportedOperationException("com.devives.rstdoclet.ConfigurationImpl.getWriterFactory() not implemented.");
