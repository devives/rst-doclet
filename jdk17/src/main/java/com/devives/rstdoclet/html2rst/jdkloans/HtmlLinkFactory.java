...
//                    }
                    if (target != null)
                        link.add(utils.getFullyQualifiedName(target));
                        //link.add(Rst4Sphinx.elements().link(utils.getFullyQualifiedName(target), label.toString()).serialize());
                    else
                        //link.add(Rst4Sphinx.elements().text(label.toString()).serialize());
                        link.add(label);
                    return link;
                }
            }
            ...
            if (crossLink != null) {
                link.add(utils.getFullyQualifiedName(typeElement));
//                link.add(crossLink);
//                if (flags.contains(ElementFlag.PREVIEW)) {
