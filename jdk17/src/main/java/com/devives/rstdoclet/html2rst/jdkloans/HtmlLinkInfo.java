...
public class HtmlLinkInfo extends LinkInfo {
     ...
     */
    public HtmlLinkInfo.Kind context = HtmlLinkInfo.Kind.DEFAULT;
     ...
     */
    public HtmlLinkInfo(RstConfiguration configuration, HtmlLinkInfo.Kind context, ExecutableElement ee) {
     ...
     */
    public HtmlLinkInfo(RstConfiguration configuration, HtmlLinkInfo.Kind context, TypeElement typeElement) {
        this.configuration = configuration;
        this.utils = configuration.utils;
     ...
     */
    public HtmlLinkInfo(RstConfiguration configuration, HtmlLinkInfo.Kind context, TypeMirror type) {
        this.configuration = configuration;
        this.utils = configuration.utils;
        this.type = type;
        setContext(context);
    ...
    public HtmlLinkInfo.Kind getContext() {
        return context;
    }
     ...
     */
    public final void setContext(HtmlLinkInfo.Kind c) {
        switch (c) {
            case ANNOTATION:
