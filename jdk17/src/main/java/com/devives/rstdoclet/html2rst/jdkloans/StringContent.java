...
public class StringContent extends Content {
     ...
     * @throws UnsupportedOperationException this method will always throw a
     ...
     */
    public Content add(String strContent) {
        return appendChars(strContent);
    }

    public Content add(CharSequence stringContent) {
        return appendChars(stringContent.toString());
    }
    ...
    private Content appendChars(String s) {
        for (int i = 0; i < s.length(); i++) {
            ...
            switch (ch) {
                ...
                case '>': stringContent.append("&gt;");  break;
                case '&': stringContent.append("&amp;"); break;
                case '\\': stringContent.append("&bslash;"); break;
