...
public abstract class JavaMemberBuilderAbst<
    ...
    public JavaMemberBuilderAbst(Directive.Type type, Element element, RstConfiguration configuration) {
        ...
        this.docContext_ = new HtmlDocletWriter(element.getEnclosingElement(), configuration);
    ...
    protected void fillElements(BlockQuoteBuilder<?> bodyBuilder) {
        ...
        List<? extends DocTree> inlineTags = configuration_.utils.getBlockTags(memberDoc_, (tag) -> tag instanceof InlineTagTree, InlineTagTree.class);
        bodyBuilder
