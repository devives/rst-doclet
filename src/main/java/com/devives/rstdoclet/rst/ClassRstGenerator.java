...
public class ClassRstGenerator implements Supplier<String> {
    ...
    public ClassRstGenerator(ClassDoc classDoc, ConfigurationImpl configuration) {
    ...
    public String get() {
        ...
        classContentBuilder
                .addChild(new JavaPackageBuilder<>(classDoc_.containingPackage(), configuration_)
                        .setNoIndex(true)
                        .build())
                ...
                .addChild(new JavaTypeBuilder<>(classDoc_, configuration_).fillImports(imports_)
                        .build())
