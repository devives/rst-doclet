...
public class ImportsCollector {
    ...
    public ImportsCollector collect(Doc doc) {
    ...
    public ImportsCollector collect(ExecutableMemberDoc execMemberDoc) {
    ...
    public ImportsCollector collect(FieldDoc fieldDoc) {
    ...
    public ImportsCollector collect(com.sun.javadoc.Type type) {
        if (counter_ > 20) {
    ...
    public ImportsCollector collect(ClassDoc classDoc) {
        return collect(classDoc, false);
    }

    public ImportsCollector collect(ClassDoc classDoc, boolean withSuperClasses) {
        if (counter_ > 20) {
            // Prevent stack overflow on `java.lang.Enum<E extends java.lang.Enum<E>>`
            return this;
        } else {
